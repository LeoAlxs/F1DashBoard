...
def section_header(label, title, subtitle=None):
    ...
    html = (
        ...
        f'<h2 style="font-size:30px; font-weight:700; margin:0 0 4px 0; font-family:\'Titillium Web\', sans-serif;">{title}</h2>'
        f'{subtitle_html}'
        f'</div>'
    )
...
with st.container(border=True):
    ...
    try:
        ...
        # Color the track line with the team color of whoever set this
        # lap, instead of Plotly's generic default blue.
